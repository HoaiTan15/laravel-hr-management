...
class EmployeeRequestController extends Controller
{
    ...
    {
        return view('employee.requests.index', ['role' => 'employee', 'active' => 'requests', 'title' => 'Phiếu yêu cầu', 'topTitle' => 'Dashboard cá nhân', 'topSub' => 'Phiếu yêu cầu', 'requests' => EmployeeRequest::with('processor')->where('created_by', $request->user()->id)->latest()->get()]);
    }

    public function create(Request $request): View
    {
        return view('employee.requests.form', ['role' => 'employee', 'active' => 'requests', 'title' => 'Tạo phiếu yêu cầu', 'topTitle' => 'Dashboard cá nhân', 'topSub' => 'Tạo phiếu yêu cầu', 'requestModel' => null, 'defaultType' => $request->string('type')->value()]);
    }
    ...
    public function show(Request $request, EmployeeRequest $requestModel): View
    {
        ...
        return view('employee.requests.show', ['role' => 'employee', 'active' => 'requests', 'title' => 'Chi tiết phiếu yêu cầu', 'topTitle' => 'Dashboard cá nhân', 'topSub' => 'Chi tiết PYC', 'requestModel' => $requestModel->load('processor')]);
    }
    ...
    public function edit(Request $request, EmployeeRequest $requestModel): View
    {
        ...
        return view('employee.requests.form', ['role' => 'employee', 'active' => 'requests', 'title' => 'Chỉnh sửa phiếu yêu cầu', 'topTitle' => 'Dashboard cá nhân', 'topSub' => 'Chỉnh sửa PYC', 'requestModel' => $requestModel, 'defaultType' => $requestModel->type->value]);
    }
